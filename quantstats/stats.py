...
def volatility(returns, period365, annualize=True):
...
def implied_volatility(returns, period365, annualize=True):
...
def sharpe(returns, rf=0., period365, annualize=True):
    """
    ...
    Args:
        ...
        * periods (int): Frequency of returns365 for daily, 12 for monthly)
...
def greeks(returns, benchmark, period365.):
...
def rolling_greeks(returns, benchmark, period365):
